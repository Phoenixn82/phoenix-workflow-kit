...
| **guard** | File-edit safety + destructive-command warnings. Freeze edits to a directory; warn before rm -rf / DROP TABLE / force-push / git reset --hard. Wrenches: careful, freeze (incl. `--clear`, formerly `unfreeze`) |
