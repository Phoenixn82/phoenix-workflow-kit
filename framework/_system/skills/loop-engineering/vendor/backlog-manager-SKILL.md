<!-- VENDORED VERBATIM from Owain Lewis. Source: https://github.com/owainlewis/agent-skills/blob/main/skills/backlog-manager/SKILL.md. Captured: 2026-06-22. Do not edit; this is upstream reference. -->
...
1. **Triage the backlog** â€” inspect open issues, current labels, stale state, linked PRs, and recent tracker changes.
2. **Prepare the queue** â€” classify issues by risk/type, mark safe work as `agent:ready`, route judgement-heavy work to `needs:human`, and add/update Agent Assessments.
3. **Maintain and report** â€” sync clearly completed issues from PR evidence, propose or create evidence-backed maintenance tickets, report branch cleanup candidates, verify the result, and summarize the next human decision.
...
### Step 2 â€” Resolve Backlog Source
...
### Step 5 â€” Sync Issue State With Pull Requests
...
### Step 6 â€” Sweep The Repo For Quality Drift
...
### Step 7 â€” Create Candidate Issues
...
### Step 8 â€” Report Unneeded Branches
